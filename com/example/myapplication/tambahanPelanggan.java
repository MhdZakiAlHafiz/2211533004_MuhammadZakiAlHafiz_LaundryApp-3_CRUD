...
public class tambahanPelanggan extends AppCompatActivity {
    SQLiteHelper db;
    Button btnPelAdd;
    ...
    private View.OnClickListener onClickListener = new
            View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(tambahanPelanggan.this, "" +mp.getNama(),
    ...
    private void eventHandling() {
        btnPelAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(tambahanPelanggan.this,
